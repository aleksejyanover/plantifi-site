...
function renderStats(){
  ...
  document.getElementById('statCards').innerHTML='<div class="level-card"><div class="level-emoji">'+cur.e+'</div><div class="level-info"><div class="level-title">Уровень садовода: '+cur.t+'</div><div class="level-bar"><div class="level-fill" style="width:'+pct+'%"></div></div><div class="level-next">'+(nxt?('До «'+nxt.t+'» осталось '+(nxt.min-xp)+' XP • всего '+xp):('Максимум! '+xp+' XP'))+'</div></div></div>'+cards.map(function(k){
